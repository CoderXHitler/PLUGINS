...
from . import START_MSG, BotHelp, Config, Symbols, db, arankbot


@arankbot.bot.on_message(
...
@arankbot.bot.on_message(filters.regex(r"New 💫") & Config.AUTH_USERS & filters.private)
async def new_session(_, message: Message):
    ...
    phone_number = await arankbot.bot.ask(
        message.chat.id,
    ...
    try:
        ...
        ask_otp = await arankbot.bot.ask(
            message.chat.id,
        ...
        try:
            ...
            two_step_pass = await arankbot.bot.ask(
                message.chat.id,
        ...
        await message.reply_text(
            "**𝖲𝗎𝖼𝖼𝖾𝗌𝗌!** 𝖲𝖾𝗌𝗌𝗂𝗈𝗇 𝗌𝗍𝗋𝗂𝗇𝗀 𝖺𝖽𝖽𝖾𝖽 𝗍𝗈 𝖽𝖺𝗍𝖺𝖻𝖺𝗌𝖾. 𝖸𝗈𝗎 𝖼𝖺𝗇 𝗇𝗈𝗐 𝗎𝗌𝖾 Arank𝖡𝗈𝗍 𝗈𝗇 𝗍𝗁𝗂𝗌 𝖺𝖼𝖼𝗈𝗎𝗇𝗍 𝖺𝖿𝗍𝖾𝗋 𝗋𝖾𝗌𝗍𝖺𝗋𝗍𝗂𝗇𝗀 𝗍𝗁𝖾 𝖻𝗈𝗍.\n\n**𝖭𝖮𝖳𝖤:** 𝖥𝗈𝗋 𝗌𝖾𝖼𝗎𝗋𝗂𝗍𝗒 𝗉𝗎𝗋𝗉𝗈𝗌𝖾𝗌 𝗇𝗈𝖻𝗈𝖽𝗒 𝗐𝗂𝗅𝗅 𝗁𝖺𝗏𝖾 𝗍𝗁𝖾 𝖺𝖼𝖼𝖾𝗌𝗌 𝗍𝗈 𝗒𝗈𝗎𝗋 𝗌𝖾𝗌𝗌𝗂𝗈𝗇 𝗌𝗍𝗋𝗂𝗇𝗀. 𝖭𝗈𝗍 𝖾𝗏𝖾𝗇 𝗒𝗈𝗎 𝗈𝗋 𝗍𝗁𝖾 𝖻𝗈𝗍."
        )
    except TimeoutError:
        await message.reply_text(
...
@arankbot.bot.on_callback_query(filters.regex(r"rm_session"))
...
@arankbot.bot.on_message(filters.regex(r"List 📜") & Config.AUTH_USERS & filters.private)
...
@arankbot.bot.on_message(filters.regex(r"Home 🏠") & filters.private & Config.AUTH_USERS)
