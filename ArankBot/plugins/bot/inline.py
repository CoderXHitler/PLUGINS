...
from arankbot.functions.templates import help_template

from ..btnsG import gen_inline_help_buttons
from . import Config, arankbot


@arankbot.bot.on_inline_query(filters.regex(r"help_menu"))
        ...
        results=[
            (
                InlineQueryResultArticle(
                    ...
                    description="Inline Query for Help Menu of arankBot",
