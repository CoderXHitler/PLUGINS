...
from arankbot.functions.templates import command_template, help_template

from ..btnsG import gen_bot_help_buttons, gen_inline_help_buttons, start_button
from . import HELP_MSG, START_MSG, Config, Symbols, arankbot
...
@arankbot.bot.on_callback_query(filters.regex(r"auth_close"))
async def auth_close_cb(_, cb: CallbackQuery):
    if await check_auth_click(cb):
        await cb.message.delete()


@arankbot.bot.on_callback_query(filters.regex(r"close"))
async def close_cb(_, cb: CallbackQuery):
    await cb.message.delete()


@arankbot.bot.on_callback_query(filters.regex(r"bot_help_menu"))
...
@arankbot.bot.on_callback_query(filters.regex(r"bot_help_cmd"))
...
@arankbot.bot.on_callback_query(filters.regex(r"help_page"))
...
@arankbot.bot.on_callback_query(filters.regex(r"help_menu"))
...
@arankbot.bot.on_callback_query(filters.regex(r"help_cmd"))
...
@arankbot.bot.on_callback_query(filters.regex(r"help_data"))
async def help_close_cb(_, cb: CallbackQuery):
    ...
    if action == "c":
        ...
        buttons = [
            [
                InlineKeyboardButton("🚀 Deploy", url="https://github.com/CoderXHitler/ArankBot"),
                InlineKeyboardButton("Plugins 📂", url="https://github.com/CoderXHitler/Plugins"),
            ],
            [
                InlineKeyboardButton("нєℓℓвσт ηєтωσяк 🇮🇳", url="https://t.me/Mr_Mrs_Krishna"),
            ],
            [
                InlineKeyboardButton("🎙️ Support", url="https://t.me/Carding_Chronicle"),
                InlineKeyboardButton("Updates 📣", url="https://t.me/Carding_Chronicle"),
            ],
            [
        ...
        await cb.edit_message_text(
            ...
            "__» Every project available under CoderXHitler are open-source and free to use and modify to your needs.__\n"
