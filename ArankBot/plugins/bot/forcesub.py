...
from arankbot.functions.admins import is_user_admin

from ..btnsG import gen_inline_keyboard
from . import BotHelp, Config, Symbols, db, arankbot


@arankbot.bot.on_message(filters.command("forcesub") & Config.AUTH_USERS & filters.group)
...
@arankbot.bot.on_message(filters.command("unforcesub") & Config.AUTH_USERS)
...
@arankbot.bot.on_message(filters.command("listforcesub") & Config.AUTH_USERS)
...
@arankbot.bot.on_message(filters.command("getforcesub") & Config.AUTH_USERS)
...
@arankbot.bot.on_callback_query(filters.regex(r"forcesub"))
