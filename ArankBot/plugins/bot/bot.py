...
from arankbot.functions.tools import restart

from ..btnsG import gen_bot_help_buttons, start_button
from . import HELP_MSG, START_MSG, BotHelp, Config, arankbot


@arankbot.bot.on_message(filters.command("start") & Config.AUTH_USERS)
...
@arankbot.bot.on_message(filters.command("help") & Config.AUTH_USERS)
...
@arankbot.bot.on_message(filters.command("restart") & Config.AUTH_USERS)
