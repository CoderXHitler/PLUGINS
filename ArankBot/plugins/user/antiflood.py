...
from Arankbot.core import Config, Symbols, db
from Arankbot.functions.utility import Flood

from . import HelpMenu, custom_handler, group_only, Arankbot, on_message
...
async def setflood(client: Client, message: Message):
    ...
    try:
        ...
        return await Arankbot.error(message, str(e))
    ...
    if count == 0:
        return await Arankbot.delete(message, "Antiflood disabled!")
...
async def antiflood(client: Client, message: Message):
    ...
    if last_user == message.from_user.id:
        if (count + 1) >= limit:
            ...
            Arank = await message.reply_text("Flood Detected!")
            ...
            if mode == "mute":
                ...
                try:
                    ...
                    return await Arankbot.error(
                        Arank, f"__Error in Antiflood while trying to mute!__\n{str(e)}"
                    )
                ...
                try:
                    ...
                    return await Arankbot.error(
                        Arank, f"__Error in Antiflood while trying to kick!__\n{str(e)}"
                    )
                ...
                try:
                    ...
                    return await Arankbot.error(
                        Arank, f"__Error in Antiflood while trying to ban!__\n{str(e)}"
                    )
