...
async def clone(client: Client, message: Message):
    ...
    if replied_user.is_self:
        return await Arankbot.delete(message, "I can't clone myself!")

    Arank = await Arankbot.edit(message, "Cloning ...")
    ...
    await Arank.edit("**😁 𝖧𝖾𝗅𝗅𝗈 𝗆𝗒 𝖿𝗋𝗂𝖾𝗇𝖽!**")
...
async def revert(client: Client, message: Message):
    ...
    if not first_name:
        return await Arankbot.delete(message, "I'm not cloned yet.")

    Arank = await Arankbot.edit(message, "Reverting ...")
    ...
    await Arank.edit("**Reverted back!**")
    await Arankbot.check_and_log(
        "revert",
