...
async def purgeMsg(client: Client, message: Message):
    ...
    Arank = await Arankbot.edit(message, "__Purging...__")
    ...
    await Arankbot.delete(Arank, f"__🧹 Purged {deleted} messages.__")
...
async def purgeMe(client: Client, message: Message):
    ...
    try:
        ...
        return await Arankbot.delete(message, "Argument must be an integer.")
    ...
    await Arankbot.delete(Arank, f"__🧹 Purged {count} messages.__")
