...
from Arankbot.functions.utility import Gcast

from . import HelpMenu, handler, Arankbot, on_message
...
async def broadcast(client: Client, message: Message):
    ...
    if msg:
        ...
        await Arankbot.check_and_log("gcast", msg[1], msg[0])
    else:
        await Arank.edit("No user or group found!")
