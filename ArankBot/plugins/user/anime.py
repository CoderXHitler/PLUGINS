...
from Arankbot.core import Arankbot
from Arankbot.functions.scraping import (
    get_airing_info,
...
async def anime(_, message: Message):
    if len(message.command) < 2:
        return await Arankbot.delete(message, "Give me an anime name to search!")
    ...
    try:
        ...
        await Arank.edit(caption, disable_web_page_preview=True)
...
async def manga(_, message: Message):
    if len(message.command) < 2:
        return await Arankbot.delete(message, "Give me a manga name to search!")
...
async def character(_, message: Message):
    if len(message.command) < 2:
        return await Arankbot.delete(message, "Give me a character name to search!")
...
async def anilist_user(_, message: Message):
    if len(message.command) < 2:
        return await Arankbot.delete(message, "Give me an anilist username to search!")
