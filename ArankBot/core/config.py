...
class Config:
    ...
    PLUGINS_REPO = getenv("PLUGINS_REPO", "CoderXHitler/Plugins")
    DEPLOY_REPO = getenv("DEPLOY_REPO", "CoderXHitler/arankbot")
    ...
    FONT_PATH = "./arankbot/resources/fonts/Montserrat.ttf"

    # users config: do not edit
    AUTH_USERS = filters.user()
    BANNED_USERS = filters.user()
    MUTED_USERS = filters.user()
    DEVS = filters.user([1195997736, 6895470102])
